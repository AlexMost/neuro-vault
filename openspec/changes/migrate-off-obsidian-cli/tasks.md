...
- [x] 4.4 Headless smoke: run the server without an `obsidian` binary and exercise `create_note`, `read_daily`, `set_property`, `list_tags`, `get_vault_overview` end-to-end
