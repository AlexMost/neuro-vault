...
- New external-command code follows the same shape; the constraint is asserted in the baseline spec and reviewable mechanically (grep for `exec(` / template strings in spawn calls).
