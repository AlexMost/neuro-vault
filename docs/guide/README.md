...
- **[Configuration](./configuration.md)** — CLI arguments, startup behavior, AGENTS.md / CLAUDE.md snippet, vault conventions for external agents, excluding paths from discovery (`.neuro-vault/config.json`), troubleshooting, limitations, development commands.
